...
@section('content')
    <div class="container-fluid py-0 px-0">
        <h1 class="h3 mb-3"><strong>Tambah Invoice</strong></h1>
                ...
                <form action="{{ route('invoices.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="is_paid" id="is_paid" class="form-select">
                            <option value="0" {{ old('is_paid') == 0 ? 'selected' : '' }}>Belum Dibayar</option>
                            <option value="1" {{ old('is_paid') == 1 ? 'selected' : '' }}>Sudah Dibayar</option>
                        </select>
                    </div>
