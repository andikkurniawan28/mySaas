        ...
        <div class="card-body">
            <form action="{{ route('profitlosses.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="revenue" id="revenue" class="form-control" value="{{ old('revenue') }}" required>
                </div>

                <div class="mb-3">
                    <label for="expense" class="form-label">Expense</label>
                    <input type="number" step="0.01" name="expense" id="expense" class="form-control" value="{{ old('expense') }}" required>
                </div>
