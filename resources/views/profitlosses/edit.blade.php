...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Hitung profit awal dari value lama
            hitungProfit();

            // Submit → kirim angka asli
